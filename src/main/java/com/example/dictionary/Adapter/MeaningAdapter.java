...
import com.example.dictionary.ViewHolder.MeaningsViewHolder;
...
public class MeaningAdapter extends RecyclerView.Adapter<MeaningsViewHolder> {
    ...
    public MeaningsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new MeaningsViewHolder(LayoutInflater.from(context).inflate(R.layout.meanings_liat_items,parent,false));
    }

    @Override
    public void onBindViewHolder(@NonNull MeaningsViewHolder holder, int position) {
        holder.textView_partSpeech.setText("Parts of Speech: "+meaningsList.get(position).getPartOfSpeech());
